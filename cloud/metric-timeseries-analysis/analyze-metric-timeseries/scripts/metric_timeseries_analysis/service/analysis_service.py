...
from metric_timeseries_analysis.service.dataset_resolver import MetricDatasetResolver


class MetricAnalysisService:
    def __init__(self, fetcher: CesFetcher | None = None) -> None:
        self.fetcher = fetcher or McpCliCesFetcher()
        self.dataset_resolver = MetricDatasetResolver(self.fetcher)
    ...
    def analyze(self, payload: dict[str, Any]) -> dict[str, Any]:
        try:
            ...
            series_by_metric = self.dataset_resolver.resolve(spec)
